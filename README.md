...
| `src/data/experience.json` | Jobs (Navio, VK, Yandex, NextShift) with highlights, tags, periods + teaching/mentoring activities. Highlights with `"backend": true` get the green "backend" badge |
